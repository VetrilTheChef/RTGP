...
void main()
{
	...
	// We don't output the dot products here as some of them are per-light
	// and the vertex shader won't be able to output enough values to handle
	// all of them, as the number of lights increases.
	...
	for (int i = 0; i < MAX_NUM_LIGHTS; i++)
	{
		...
		vs_lights.kL[i] = vec3(lights.colors[i]) * lights.colors[i].w;
